...
import com.squillaci.autodiag.bluetoothmanager.BluetoothConnectionState
import com.squillaci.autodiag.bluetoothmanager.BluetoothViewModel
import com.squillaci.autodiag.geminianalysis.ObdData
import com.squillaci.autodiag.geminianalysis.buildPromptLLMReport
import com.squillaci.autodiag.geminianalysis.viewmodel.LLMViewModel
...
import com.squillaci.autodiag.ui.theme.LabelColor
import com.squillaci.autodiag.ui.theme.Rpm
...
fun CarLottieAnimation(modifier: Modifier = Modifier) {
    val composition by rememberLottieComposition(
        LottieCompositionSpec.RawRes(com.squillaci.autodiag.R.raw.green_moving_car)
    )
...
//            ),
            ...
            drawLine(
                color =
                    //com.squillaci.autodiag.ui.theme.Speed,
                    Rpm,
                    //AppBgDark,
                    //Color.Red,
                start = center,
